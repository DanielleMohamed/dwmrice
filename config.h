...
//static const char *fonts[]          = { "Roboto Mono Nerd Font:size=20" };
//static const char *fonts[]          = { "monospace:size=20", "Monospace Nerd Font:size=40" };
static const char *fonts[]          = { "monospace:size=20", "Ubuntu Mono Nerd Font:size=20" };
...
const char *spcmd1[] = {"st", "-n", "spfm", "-g", "288x82", "-e", "newsboat", NULL };
const char *spcmd2[] = {"st", "-n", "spfm", "-g", "288x82", "-e", "ranger", NULL };
//const char *spcmd1[] = {"st", "-n", "spterm", "-g", "120x34", NULL };
//const char *spcmd2[] = {"st", "-n", "spfm", "-g", "144x41", "-e", "ranger", NULL };
const char *spcmd3[] = {"st", "-n", "spfm", "-g", "288x82", "-e", "ping 8.8.8.8", NULL };
